...
var auditSql = sqlContainer.GetConnectionString();
Console.WriteLine($"audit connection string: {auditSql}");
...
// Infrastructure implementations of the application's persistence abstractions.
